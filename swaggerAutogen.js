...
const outputFile = './swagger.json' // Burada oluşturduğumuz json'ı bu isimli dosyaya yapıştır diyoruz // creating output file
const routes = ['./index.js'] // route'ları index.js'den bulabilirsin
